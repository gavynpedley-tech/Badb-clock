...
3. **The countdown** — an animated character (choose one that looks like your kid) walks across a calm scene toward the destination as the time runs down. A green progress bar shrinks alongside, and in the last 10 seconds everything gently shifts to "Nearly there!".
